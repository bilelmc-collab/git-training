...
public class GitTrainingApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("change 10 in new branch num 1-1 change from remote repository!");
        System.out.println("change 11 in new branch num 1-1 change from local repository!");
